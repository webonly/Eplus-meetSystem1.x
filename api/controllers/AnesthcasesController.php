...
/**
 * AnesthcasesController implements the CRUD actions for Cases model.
 */
class AnesthcasesController extends CommonController
{
...
";
        $rs = Cases::findBySql($sql)->asArray()->all();
    ...
    public function actionCasescont()
    {
        ...
        $rs = Cases::findBySql('SELECT MC_ID,MC_Title,MC_Content,MC_CreateOn  FROM MInfo_Cases WHERE MC_ID='.$contid)->asArray()->all();
