...
use Yii;
use api\models\ophth\ophthConstruct;
...
/**
 * OphthconstructController implements the CRUD actions for ophthConstruct model.
 */
class OphthconstructController extends CommonController
{
    ...
    /**
     * Lists all ophthConstruct models.
     * @return mixed
     */
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => ophthConstruct::find(),
        ]);
...
";
        $rs = ophthConstruct::findBySql($sql)->asArray()->all();
    ...
    public function actionSubjectcont()
    {
        ...
        $rs = ophthConstruct::findBySql('SELECT MC_ID,MC_Title,MC_Content,MC_CreateOn  FROM MInfo_Construct WHERE MC_ID='.$contid)->asArray()->all();
   ...
   for ($i=0;$i<count($rs);$i++){
    ...
    /**
     * Displays a single ophthConstruct model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new ophthConstruct model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new ophthConstruct();
    ...
    /**
     * Updates an existing ophthConstruct model.
    ...
    /**
     * Deletes an existing ophthConstruct model.
    ...
    /**
     * Finds the ophthConstruct model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ophthConstruct the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ophthConstruct::findOne($id)) !== null) {
            return $model;
        } else {
